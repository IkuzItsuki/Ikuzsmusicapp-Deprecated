...
import com.ikuz.ikuzsmusicapp.fragments.LocalAlbumFragment
import com.ikuz.ikuzsmusicapp.fragments.LocalArtistFragment
import com.ikuz.ikuzsmusicapp.fragments.LocalSongFragment
import com.ikuz.ikuzsmusicapp.R
import com.ikuz.ikuzsmusicapp.databinding.ActivityLocalBinding
...
class LocalActivity : FragmentActivity() {
    ...
    private fun requestPermission(){
        if(ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_EXTERNAL_STORAGE)){
            Toast.makeText(this, "Permission denied, please go to setting to enable it", Toast.LENGTH_LONG).show()
        }
